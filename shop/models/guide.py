...
class Guide(BaseModel):
    ...
    flexibility = models.CharField(max_length=10, blank=True, verbose_name=_("Flexibility"))  # 신축성
    see_through = models.CharField(max_length=10, blank=True, verbose_name=_("See Through"))  # 비침
    thickness = models.CharField(max_length=10, blank=True, verbose_name=_("Thickness"))  # 두께
